...
export default function ReportSelector() {
  ...
  return (
    <div className="flex gap-2 items-center">
      <select className="p-2 bg-gray-800 border rounded-lg border-gray-700 focus:outline-none focus:border-gray-500" name="report" value={selectedReport} onChange={handleChange}>
